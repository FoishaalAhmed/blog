        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
					<a href="{{route('admin.blogs.index')}}" class="btn btn-sm bg-teal"><i class="fas fa-list-alt"></i> {{__('Blogs')}}</a>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<div class="col-md-12">
											...
											<input type="text" name="title" class="form-control" placeholder="{{__('Title')}}" required="" autocomplete="off" id="title" value="{{old('title')}}"/>
										</div>
									</div>
									<!-- /.form-group -->
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="col-md-12">
											<label>{{__('Slug')}}</label>
											<input type="text" name="slug" class="form-control" placeholder="{{__('Slug')}}" required="" autocomplete="off" id="slug" value="{{old('slug')}}"/>
										</div>
									</div>
									<!-- /.form-group -->
								</div>
