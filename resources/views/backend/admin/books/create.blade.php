        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">{{ __('New Book') }}</h3>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="suitable_for" class="form-control"
                                                    ...
                                                    id="suitable_for" value="{{ old('suitable_for') }}" />
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="publish_year" class="form-control"
                                                    ...
                                                    id="publish_year" value="{{ old('publish_year') }}" />
                                            </div>
                                        </div>
                                        <!-- /.form-group -->
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-primary card-outline">
                                            ...
                                            <div class="card-body box-profile">
                                                ...
                                                <br>
                                                <input type="file" name="pdf" style="width: 100%" required="">
                                            </div>
                                            <!-- /.card-body -->
                                        </div>
                                    </div>
