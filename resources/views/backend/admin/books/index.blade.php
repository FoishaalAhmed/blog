                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('Book List') }}</h3>
                            <div class="card-tools">
                                <a href="{{ route('admin.books.create') }}" class="btn btn-sm bg-teal"><i
                                        class="fas fa-plus-square"></i> {{ __('Create Book') }}</a>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%">{{ __('Suitable For') }}</th>
                                        <th style="width: 15%">{{ __('Author') }}</th>
                                        <th style="width: 15%">{{ __('Publish Year') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm bg-blue"
                                                    href="{{ route('admin.books.edit', [$item->id]) }}"><span
