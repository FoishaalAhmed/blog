...
<head>
  ...
  <title>Ishkul | @yield('title')</title>
...
`body` tag options:
  ...
  * sidebar-mini
-->
<body class="hold-transition sidebar-mini dark-mode sidebar-collapse" <?php if (session()->has('message')) echo "onload='setTimeout(snackbar_function, 100)';" ?> >
  <div id="snackbar">{{session('message')}}</div>
<div class="wrapper">
  <!-- Preloader -->
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="https://ictbanglabd.com/public/assets/img/logo.png" alt="ICTBangla" height="60" width="60">
  </div>
  <!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Ishkul</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; {{date('Y')}} <a href="{{URL::to('/')}}">ishkul.org</a>.</strong>
    All rights reserved.
